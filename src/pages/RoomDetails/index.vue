...
<template>
    <div v-if="roomsStore.roomDetails" class="flex-1">
        <!-- Carousel -->
        <div
            v-if="roomsStore.roomDetails.imgs.length > 0"
                ...
                >
                    ...
                    <div class="flex mb-4">
                        ...
                        >
                            ...
                            <span
                                >{{
                                    roomsStore.roomDetails.info.room
                                }}
                                间卧室</span
                            >
                        </div>
                        ...
                        >
                            ...
                            <span
                                >{{
                                    roomsStore.roomDetails.info.bed
                                }}
                                张床</span
                            >
                        </div>
                        ...
                        >
                            ...
                            <span
                                >{{
                                    roomsStore.roomDetails.info.toilet
                                }}
                                间卫生间</span
                            >
                        </div>
                        ...
                        >
                            ...
                            <span
                                >可住
                                {{ roomsStore.roomDetails.info.liveNumber }}
                                人</span
                            >
                        </div>
                    </div>
                    ...
                    <div class="owner-details flex">
                        ...
                        <div class="ml-4 py-2">
                            ...
                            <p class="font-semibold text-sm text-gray-darkest">
                                <span
                                    v-if="roomsStore.roomDetails.owner.certify"
                                >
                                    已验证身份
                                </span>
                                <span
                                    v-if="roomsStore.roomDetails.info.goodOwner"
                                >
                                    · 超赞房东
                                </span>
                            </p>
            ...
            <div class="form-container w-1/3">
                <div class="border border-solid border-zinc-200 pt-4 px-6">
                    ...
                    <div>
                        ...
                        <span class="text-gray-darkest text-xs font-semibold"
                            >/晚</span
                        >
                    </div>

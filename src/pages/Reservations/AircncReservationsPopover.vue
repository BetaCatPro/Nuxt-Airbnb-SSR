...
<template>
    ...
    >
        <div v-if="reservations.length > 0">
            <!-- Name -->
            <h3
                class="name pt-1 px-1 pb-4 text-gray-darkest text-sm font-extrabold"
            >
            ...
            <ul>
                ...
                >
                    <div
                        class="reservation py-4 flex justify-between items-center"
                    >
                        <div class="content">
                            <div>
                                <p
                                    class="title text-sm font-semibold text-gray-darkest"
                                >
                                    {{
                                        t(`home.city.${reservation.city}`)
                                    }}的整套房子/公寓
                                </p>

                                <div
                                    v-if="
                                        JSON.parse(reservation.date).length ===
                                        2
                                    "
                        ...
                        <div
                            v-if="reservation.pictureURL"
                            class="thumbnail ml-4"
                        >
